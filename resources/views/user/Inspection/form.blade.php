...
@section('content')
    <div class="container-fluid py-4">
        <div class="row mb-4">
            <div class="col-12">
                <h2 class="fw-bold text-dark">Formulir Inspection After Repair</h2>
                <p class="text-muted mb-0">Formulir Inspection After Repair ini untuk section DT, SDT, dan A2B bertujuan untuk mendukung proses inspeksi dan ada hasil untuk history terkait pelaporan inspeksi unit</p>
                <hr class="mt-3 mb-0">
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4 position-relative">
                                    ...
                                    <input type="text" name="cn_unit" id="cn_unit"
                                        class="form-control rounded-3 @error('cn_unit') is-invalid @enderror" autocomplete="off" required>
