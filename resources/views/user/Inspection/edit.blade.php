...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">Edit Formulir Inspeksi</li>
@endsection
            ...
            <div class="col-12">
                <div class="card shadow-sm border-0 rounded-3">
                    <div class="card-body p-4">
                        ...
                        <!-- Form -->
                        <form action="{{ route('user.inspection.resubmit', $form['ID']) }}" method="POST"
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select name="section" id="section"
                                        ...
                                        <option value="Section DT"
                                            {{ old('section', $form['Section']) == 'Section DT' ? 'selected' : '' }}>
                                            Section DT
                                        </option>
                                        <option value="Section SDT"
                                            {{ old('section', $form['Section']) == 'Section SDT' ? 'selected' : '' }}>
                                            Section
                                            SDT</option>
                                        <option value="Section A2B"
                                            {{ old('section', $form['Section']) == 'Section A2B' ? 'selected' : '' }}>
                                            Section
                                            A2B</option>
                                    </select>
                                    @error('section')
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select name="supervisor" id="supervisor"
                                        ...
                                        <option value="Ari Handoko"
                                            {{ old('supervisor', $form['Supervisor']) == 'Ari Handoko' ? 'selected' : '' }}>
                                            Ari
                                            Handoko
                                        </option>
                                        <option value="Teo Hermansyah"
                                            {{ old('supervisor', $form['Supervisor']) == 'Teo Hermansyah' ? 'selected' : '' }}>
                                            Teo
                                            Hermansyah</option>
