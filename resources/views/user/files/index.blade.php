        ...
        <div class="row g-3"> <!-- Tambahkan g-3 untuk margin antar card -->
            @foreach ($folders as $folder)
                <div class="col-6 col-sm-6 col-md-4 folder-item"> <!-- 2 kolom di smartphone -->
                    <div class="card shadow-sm folder-card" onclick="window.location='{{ route('user.files.show', $folder->id_folder) }}'"
                        ...
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="card-title mb-1 fs-6 text-white">{{ $folder->nama }}</h5>
                                <small class="d-block fs-7 text-white">{{ $folder->subfolders->count() }} subfolders</small>
