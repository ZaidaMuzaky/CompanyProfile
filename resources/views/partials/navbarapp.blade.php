...
<aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        @php
            ...
            $isGeneralOpen =
                request()->routeIs('user.newsview.*') ||
                request()->routeIs('user.gform.index') ||
                request()->routeIs('user.pareto.index') ||
                request()->routeIs('menus.view') ||
                request()->routeIs('audit.view');
        @endphp

        <!-- GENERAL INFORMATION PLANT -->
        <li class="nav-item">
            <a class="nav-link {{ $isGeneralOpen ? '' : 'collapsed' }}" data-bs-target="#general-info-plant"
                data-bs-toggle="collapse" href="#">
                <i class="bi bi-building"></i> <span>General Information Plant</span> <i
                    class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="general-info-plant" class="nav-content collapse {{ $isGeneralOpen ? 'show' : '' }}"
                ...
                {{-- <li>
                    ...
                    <ul id="pareto-problem-unit" class="nav-content collapse" data-bs-parent="#general-info-plant">
                        @foreach ($mainMenus as $mainMenu)
                            <li>
                                <a data-bs-toggle="collapse" href="#menu-{{ $mainMenu->id }}"
                ...
                {{-- @if ($menus->count() > 0)
                    <li>
                        <a class="nav-link collapsed" data-bs-target="#menu-database" data-bs-toggle="collapse"
                            href="#">
                            <i class="bi bi-folder"></i> <span>KPI Plant</span> <i
                                class="bi bi-chevron-down ms-auto"></i>
                        </a>
                        <ul id="menu-database"
                ...
                @if ($audits->count() > 0)
                    <li>
                        <a class="nav-link collapsed" data-bs-target="#menu-audit" data-bs-toggle="collapse"
                            href="#">
                            <i class="bi bi-folder-check"></i> <span>Audit Service</span> <i
                                class="bi bi-chevron-down ms-auto"></i>
                        </a>
                        <ul id="menu-audit"
                            class="nav-content collapse {{ request()->routeIs('audit.view') ? 'show' : '' }}"
                            data-bs-parent="#general-info-plant">
        ...
        @if (Auth::check() && Auth::user()->type === 'admin')
            ...
            @php
                $isAdminOpen =
                    request()->routeIs('admin.google-form.*') ||
