...
@section('content')
    <div class="container-fluid py-4">
        <div class="row mb-4">
            <div class="col-12">
                <h2 class="fw-bold text-dark">Edit Header Image</h2>
                <p class="text-muted mb-0">Perbarui gambar header untuk halaman backlog.</p>
                <hr class="mt-3 mb-0">
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card shadow-sm border-0 rounded-3">
                    <div class="card-body p-4">
                        ...
                        <!-- Form upload gambar -->
                        <form action="{{ route('admin.backlog.backlog-header.update') }}" method="POST"
                            ...
                            <div class="mb-4">
                                ...
                                @enderror
                                <small class="text-muted mt-1 d-block">Format yang didukung: JPG, PNG, max 5MB.</small>
                            </div>
    ...
    <script>
        ...
        document.getElementById('header_image').addEventListener('change', function(e) {
            ...
            if (file) {
                ...
                preview.className = 'img-fluid rounded-3 shadow-sm mt-3';
