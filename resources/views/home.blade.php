...
@section('content')
    ...
    <section id="home" class="hero section position-relative overflow-hidden" style="min-height: 100vh;">
        ...
        <div id="backgroundCarousel" class="carousel slide position-absolute w-100 h-100" data-bs-ride="carousel"
            style="z-index: 1;">
            <div class="carousel-inner h-100">
                <div class="carousel-item active h-100">
                    <img src="{{ asset('assets/img/bgwebcp1.jpg') }}" class="d-block w-100 h-100" style="object-fit: cover;"
                        alt="Slide 1">
                </div>
                <div class="carousel-item h-100">
                    <img src="{{ asset('assets/img/cp-img.jpg') }}" class="d-block w-100 h-100" style="object-fit: cover;"
                        alt="Slide 2">
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
                    <div id="tentangImageCarousel" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item">
                                <img src="{{ asset('assets/img/ttgpr4.jpg') }}" class="d-block w-100 img-fluid"
                                    alt="Gambar 4">
                            </div>
                        </div>
    ...
    <section id="plant" class="plant section">
                    ...
                    @foreach ($plantImages as $index => $img)
                        <div class="carousel-item @if ($index === 0) active @endif">
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset($img) }}" class="img-fluid rounded plant-img-card"
                                    alt="Plant Image {{ $index + 1 }}" style="max-height: 500px;" data-bs-toggle="modal"
                                    data-bs-target="#plantImageModal" onclick="showPlantModal(this)">
                            </div>
                        </div>
                    @endforeach
                </div>
        ...
        <!-- Modal Gambar Plant -->
        <div class="modal fade" id="plantImageModal" tabindex="-1" aria-labelledby="plantImageModalLabel"
            aria-hidden="true">
    ...
    <section id="Video" class="video section section">
        <div class="section-full-bg">
            <div class="container" data-aos="fade-up">
                <div class="section-title text-center text-white">
                    <h2 style="color: #fff;">Tentang Plant</h2>
                    <p style="color: #fff;">Video Serie Plant Efficiency</p>
                </div>
            </div>
        </div>
        <div class="container mt-4" data-aos="fade-up">
                        ...
                        <div class="carousel-item @if ($chunkIndex === 0) active @endif">
                            <div class="row">
                                @foreach ($chunk as $achievement)
                                    <div class="col-md-4">
                                        <div class="card">
                                            <img src="{{ asset('storage/' . $achievement->gambar) }}"
                                                class="card-img-top" alt="{{ $achievement->judul }}">
                                            <div class="card-body">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 gy-4"> <!-- Tambahkan gy-4 untuk margin antar card -->
                ...
                <div class="col-12 col-sm-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="card card-small">
                        ...
                        <h3>Section A2B</h3>
                        <p>Bertanggungjawab atas maintenance unit track <br>( BULDOSER, COMPECTOR, DOOSAN, EXCAVATOR, MOTOR
                            GRADER )</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                    <div class="card card-small">
                        ...
                        <p>Bertanggungjawab atas maintenance unit support ( FUEL TRUCK, WATER TRUCK, LOBOY, LV, TOWER LAMP,
                            GENSET, POMPA, TRUCK
                            SUPPORT )</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4" data-aos="fade-up" data-aos-delay="700">
                    <div class="card card-small">
                        ...
                        <h3>Section Comex</h3>
                        <p>Bertanggungjawab atas overhaul komponen unit <br>( ENGINE, TRANSMISI, DIFERENSIAL, <br>FINAL
                            DRAVE )</p>
                    </div>
                </div>
